...
export default function Service() {
  return (
    ...
    <section id="Services" className="container mx-auto text-[#00373E]">
      <div className=" text-center text-[#00373E] space-y-4">
      ...
      {/* Parent Card */}
      <div className="mt-16 space-y-10  md:flex md:justify-around md:items-start gap-x-5">
        {/* Card One */}
        <div className="flex justify-around bg-[#F9E6D0] rounded-3xl max-h-80  min-h-80 md:w-1/2 shadow-md">
          <div className="flex flex-col justify-items-center rounded-3xl p-5 md:p-10 gap-8 justify-evenly  ">
            ...
            <button className="hover:scale-110 duration-300 ease-out cursor-pointer hover:shadow-[#00373E] bg-transparent text-[#00373E] rounded-3xl md:px-7 md:py-3 px-5 py-2  font-bold border-1 border-[#00373E] max-w-36 hover:shadow-md  hover:text-white  hover:bg-[#00373E] ">
              Learn more
            </button>
          </div>
          <img
        ...
        {/* Card Two */}
        <div className=" flex flex-col justify-items-center md:w-1/2 min-h-80 max-h-80 bg-[#ffff] rounded-3xl p-5 md:p-10 gap-8 justify-evenly ">
          ...
          <button className="hover:scale-110 bg-transparent text-[#00373E] rounded-3xl md:px-7 md:py-3 px-5 py-2 font-bold border-1 border-[#00373E] max-w-36 hover:shadow-md hover:shadow-[#00373E] hover:bg-[#00373E] hover:text-white duration-300 ease-out cursor-pointer  ">
            Learn more
          </button>
        </div>
      </div>
      <div className="mt-16 flex justify-between bg-[#ffff] rounded-3xl w-full p-5 md:p-10 gap-8 overflow-hidden">
